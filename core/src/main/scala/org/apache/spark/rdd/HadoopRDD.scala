    ...
    val iter = new NextIterator[(K, V)] {
      ...
      override def getNext(): (K, V) = {
        try {
          ...
          //dschatzl
          val recordtime = System.nanoTime() - startrecord
          READ_TIME = READ_TIME + recordtime
      ...
      override def close() {
        ...
        //dschatzl
        logInfo("OLD: [" + context.taskMetrics.netOH + "] , NEW: [" + READ_TIME + "]")
        context.taskMetrics.setNetOH(READ_TIME/1000000)
